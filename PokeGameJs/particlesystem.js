...
const CloudLeftConfi = {
    ...
    AREA_X1: 0,
    AREA_Y1: 0,
    AREA_X2: typeof(canvas) !== 'undefined' ? canvas.width : 0,
    AREA_Y2: typeof(canvas) !== 'undefined' ? canvas.height : 1000,

    MIN_INITIAL_VELOCITY: 10,
    MAX_INITIAL_VELOCITY: 40,
    ...
    MIN_OPACITY_DECREMENT_VELOCITY: 0.02,
    MAX_OPACITY_DECREMENT_VELOCITY: 0.1,

    MIN_INITIAL_SCALE: 1.5,
    MAX_INITIAL_SCALE: 3,

    MIN_SCALE_VELOCITY: 0.2,
    MAX_SCALE_VELOCITY: 0.5,

   MIN_INITIAL_ROTATION: 0,
   MAX_INITIAL_ROTATION: 0,

    MIN_ROTATION_VELOCITY: 0,
    MAX_ROTATION_VELOCITY: 0,

    MIN_TIME_TO_SPAWN_PARTICLE: 2,
    MAX_TIME_TO_SPAWN_PARTICLE: 1
}
...
class Particle {
    ...
    Update(deltaTime) {
        if (this.appearing) {
            ...
            this.opacity += this.opacityVelocity * 1.0 * deltaTime;
            if (this.opacity >= 1.0) {
                this.opacity = 1.0;
                this.appearing = false;
            ...
            this.scale -= this.scaleVelocity * 0.05* deltaTime;
    ...
    Draw(ctx) {
       ...
       // ctx.drawImage(this.img,imageposx*200, this.imageposy*200, 200, 200);
...
class ParticleSystem {
    constructor(img, config, position) {
        ...
        this.config = {};
        Object.assign(this.config, CloudLeftConfi);
